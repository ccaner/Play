...
public class RemotableBeanProcessor implements BeanPostProcessor, ApplicationContextAware {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        try {
            if (remotable != null) {
                ...
                InvocationHandler invocationHandler = new RemotableInvocationHandler<Object>(bean,
                        (Class<? super Object>) remotable.value());
    ...
    private Object proxyObject(Class<?>[] interfaces, Class<?> superClass, final InvocationHandler invocationHandler) {
